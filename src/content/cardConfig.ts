...
export const CARD_DEFINITIONS: readonly CardDefinition[] = [
  ...
  },
  {
    ...
    rarity: "common",
    name: "Far Ward",
    description: "Small watchstones extend each banner's defensive reach.",
    maxStacks: 3,
  ...
  },
  {
    ...
    houseId: "house_a",
    name: "Emberguard",
    description: "Ashvale tempers its blades in the fire beneath the keep.",
    maxStacks: 2,
  ...
  },
  {
    ...
    houseId: "house_b",
    name: "Deep Horns",
    description: "Low horns carry the banner alarm across the battlefield.",
    maxStacks: 2,
  ...
  },
  {
    ...
    name: "Last Bastion",
    description:
      "While any defense is below 25% HP, every agent deals 30% more damage.",
    maxStacks: 1,
    effect: {},
  },
  {
